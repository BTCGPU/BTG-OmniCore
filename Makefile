...
ACLOCAL = ${SHELL} /media/ale/data/BTCGPU/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /media/ale/data/BTCGPU/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/ale/data/BTCGPU/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/ale/data/BTCGPU/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /media/ale/data/BTCGPU/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /media/ale/data/BTCGPU
abs_srcdir = /media/ale/data/BTCGPU
abs_top_builddir = /media/ale/data/BTCGPU
abs_top_srcdir = /media/ale/data/BTCGPU
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/ale/data/BTCGPU/build-aux/install-sh
