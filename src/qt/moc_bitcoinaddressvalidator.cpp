...
const QMetaObjectExtraData BitcoinAddressEntryValidator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BitcoinAddressEntryValidator::staticMetaObject = {
    { &QValidator::staticMetaObject, qt_meta_stringdata_BitcoinAddressEntryValidator,
      qt_meta_data_BitcoinAddressEntryValidator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BitcoinAddressEntryValidator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BitcoinAddressEntryValidator))
...
const QMetaObjectExtraData BitcoinAddressCheckValidator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BitcoinAddressCheckValidator::staticMetaObject = {
    { &QValidator::staticMetaObject, qt_meta_stringdata_BitcoinAddressCheckValidator,
      qt_meta_data_BitcoinAddressCheckValidator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BitcoinAddressCheckValidator::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BitcoinAddressCheckValidator))
