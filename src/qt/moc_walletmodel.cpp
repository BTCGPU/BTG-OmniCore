...
static const char qt_meta_stringdata_WalletModel[] = {
    ...
    "balanceChanged(CAmount,CAmount,CAmount,CAmount,CAmount,CAmount)\0"
    "status\0encryptionStatusChanged(int)\0"
    "requireUnlock()\0title,message,style\0"
    "message(QString,QString,uint)\0"
    "wallet,recipient,transaction\0"
    "coinsSent(CWallet*,SendCoinsRecipient,QByteArray)\0"
    "title,nProgress\0showProgress(QString,int)\0"
    "fHaveWatchonly\0notifyWatchonlyChanged(bool)\0"
    "updateStatus()\0updateTransaction()\0"
    "address,label,isMine,purpose,status\0"
    "updateAddressBook(QString,QString,bool,QString,int)\0"
