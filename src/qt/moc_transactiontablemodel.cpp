...
static const char qt_meta_stringdata_TransactionTableModel[] = {
    "TransactionTableModel\0\0"
    "hash,status,showTransaction\0"
    "updateTransaction(QString,int,bool)\0"
    "updateConfirmations()\0updateDisplayUnit()\0"
    "updateAmountColumnTitle()\0value\0"
    "setProcessingQueuedTransactions(bool)\0"
};
