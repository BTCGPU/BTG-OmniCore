...
static const char qt_meta_stringdata_ClientModel[] = {
    ...
    "count,blockDate,nVerificationProgress,header\0"
    "numBlocksChanged(int,QDateTime,double,bool)\0"
    "count,mempoolSizeInBytes\0"
    "mempoolSizeChanged(long,size_t)\0"
    "networkActive\0networkActiveChanged(bool)\0"
    ...
    "updateNumConnections(int)\0"
    "updateNetworkActive(bool)\0updateAlert()\0"
    "updateBanlist()\0"
};
